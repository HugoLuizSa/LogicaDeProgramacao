...
public class SituacaoDeAprendizado {
					...
					do {
						...
						if (menuVenda == 2) {
							int codVendaSeraEditata = Integer.parseInt(
									JOptionPane.showInputDialog("Informe o código da venda que será editada : "));
							CriarEditarVenda(codVendaSeraEditata);
						}
						// vizualizar venda
						if (menuVenda == 3) {
							int codVendaSeraVizualizada = Integer.parseInt(
									JOptionPane.showInputDialog("Informe o código da venda que será vizualizada : "));
					...
					do {
						...
						if (menuProduto == 3) {
							int codProdutoPesquisado = Integer.parseInt(
									JOptionPane.showInputDialog("Digite o código do produto que deseja verificar : "));
					...
					do {
						...
						if (menuCliente == 2) {
							int codClienteEditadar = Integer.parseInt(
									JOptionPane.showInputDialog("Informe o código do cliente que deseja editar"));
							cadastrarCliente(codClienteEditadar);
						}
						// vizualizar cliente
						if (menuCliente == 3) {
							int codClientePesquisado = Integer.parseInt(
									JOptionPane.showInputDialog("Digite o código do cliente que deseja verificar : "));
				...
				if (menuPrincipal == 4) {
					do {
						menuRelatorios = Integer.parseInt(JOptionPane.showInputDialog(
								"Informe o numero do relatório que você deseja tirar :\n" + menuRelatorios()));
						...
						// listar os produtos por ordem de preço
						if (menuRelatorios == 4) {
			...
			try {
				...
				if (!validarDescricaoProduto(desc)) {
					JOptionPane.showMessageDialog(null,
							"Descrição inválida , verifique seu arquivo antes de importar !");
	...
	public static void editarProduto() {
		...
		try {
			codProduto = Integer.parseInt(JOptionPane.showInputDialog(
					"Informe o código do produto procurado : \n +Lista produtos : \n" + listaProdutos()));
		} catch (Exception e) {
	...
	// verifica se um cliente é válido através do código , caso válido retorna o
	// cliente
	...
	// 1 Criar venda
	// metodo para importar os produtos
	// parametro cod : 0 nova venda , valores acima de zero é para editar a venda
		...
		while (codProd > 0 || codProd == 5) {
			try {
				...
				codProd = Integer.parseInt(
						JOptionPane.showInputDialog("Informe o código do produto que você deseja #" + contProdutos
								+ "\n" + listarProdutos() + "\n" + "\n -----Carrinho------" + "\n Items adicionados \n"
			...
			if (venda.produtos[4] != null) {
				JOptionPane.showMessageDialog(null,
						"Inserido a quantidade máxima de produtos , finalizada a insersão de produtos !");
				codProd = 0;
				JOptionPane.showMessageDialog(null, "Seus items são : \n" + prodsAdicionados);
			}
		}
	...
	public static void listarVendasOrdermMenorVenda() {
		...
		// algoritmo de ordenação booble shot
		for (int i = 0; i < copiaVendas.length; i++) {
			for (int j = 0; j < copiaVendas.length - 1; j++) {
				...
				// verificar se a venda atual ou a proxima venda está vazia
	...
	// 4 Ordenado pelo preço do menor produto Mostrar todos os produtos com seus
	// respectivos dados
	public static void listarProdutosOrdemPreco() {
		...
		for (int i = 0; i < newProdutos.length; i++) {
			...
			// finalizado o for interno , agora se sabe quem é o produto com meno preco no
			// array
